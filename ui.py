...
def setup_ui(self):
        ...
        self.style.configure('TScale',
                        ...
                        background="#2C2929", borderwidth=0, relief='flat') 
        self.time_slider = ttk.Scale(self.midle_frame, from_=0, to=100, orient="horizontal", value=0, length=600, style="Custom.Horizontal.TScale", command=self.on_slider_move)# 664
        ...
        self.controls_frame = tk.LabelFrame(self.central_frame, text='CONTROLS->- ', font=("Terminal", 8), bg="#2C2929", fg="green")#fg="#E1B19E",  labelanchor="n",
