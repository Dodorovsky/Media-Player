...
def setup_ui(self):
        ...
        self.root.geometry("570x470")# 560x470
        ...
        self.midle_frame.grid(columnspan=5, sticky="nsew")
        ...
        self.current_time_label = tk.Label(self.midle_frame, text="--:--", font=("Terminal", 8), fg="#E9E4B2", bg='#3A3535')##E9E4B2, #FFFCE8
        self.current_time_label.grid(row=3, column=0, padx=(0, 492))
        self.total_time_label = tk.Label(self.midle_frame, text="--:--", font=("Terminal", 8), fg="#E9E4B2", bg='#3A3535')#CAFFFE
        ...
        self.vu_frame_left.grid(row=2, column=0,padx= (5,0), pady=10, sticky="nsew")
        
        self.vu_frame_right = tk.Frame(self.main_frame, bg="#3A3535")
        self.vu_frame_right.grid_columnconfigure(0, weight=1)
        self.vu_frame_right.grid(row=2, column=4, padx=(0,14), pady=10, sticky="nsew")
        
        # Left Frame
        self.left_frame = tk.Frame(self.main_frame, bg="#3A3535")
        self.left_frame.grid(pady=15,row=2, column=1, sticky="nswe")
        ...
        self.controls_frame.grid(row=0, column=0, padx=(20,0), pady=13) 
        ...
        self.right_frame.grid(padx=(8,8),pady=30, row=2, column=3, sticky="nswe")   
        ...
        self.left_vu_label.grid(padx=(0), pady=(0))
