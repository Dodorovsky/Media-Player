...
def setup_ui(self):
        ...
        self.black_frame = tk.Frame(self.main_frame, bg="#2C2929")##232121, 181717
        ...
        self.hal_label = tk.Label(self.black_frame, image=self.hal_on, bg='#2C2929')
        ...
        self.video_frame = tk.Frame(self.top_frame, width=450, height=195, bg="black")# width=450, height=340
        ...
        self.style.configure('Custom.Horizontal.TScale',
                        ...
                        background='#2C2929', borderwidth=0, relief='flat') # fondo del widget (no el thumb)
        ...
        self.playlist_label.grid(pady=(2))
        ...
        self.volume_label_frame.grid(row=2, padx=(10,0), column=0, columnspan=2)
        
        self.mute_button = tk.Button(self.right_frame, text="MUTE", font=("Terminal", 6), command=self.toggle_mute, bg="#0F0E0E", fg="#E0D2D2")
        self.mute_button.grid(row=3, column=0, columnspan=2,padx=(7,0),pady=5)

        
        # Random Button
        self.shuffle_button = tk.Button(self.central_frame, text="RANDOM", font=("Terminal", 6), bg="#191818", fg="#E0D2D2", command=self.toggle_shuffle)#BDCCD6
        self.shuffle_button.grid(row=1,padx=(0, 15), pady=(15,0))

        # Loop Button
        self.loop_button = tk.Button(self.central_frame, text=" LOOP ", font=("Terminal", 6), bg="#191818", fg="#E0D2D2", command=self.toggle_loop)#C2DDAC, C4A98A
        ...
        self.compact_button = tk.Button(self.vu_frame_left, text="CRT/AMP", font=("Terminal", 7, "bold"), bg="#191818", fg="#E0D2D2", command=self.compact)
        ...
        self.playlist_button.grid(padx=(0,3), pady=(0,10), column=0)
